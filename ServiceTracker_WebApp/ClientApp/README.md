...
Scaffold-DbContext "Server=(localdb)\MSSQLLocalDB;Database=TestST;Integrated Security=true;" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Models
Scaffold-DbContext "Server=no2016app05;Database=ST;Integrated Security=true;" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Models
https://handsontable.com/docs/7.0.3/demo-custom-buttons.html


Download .netcore bundle server from 
